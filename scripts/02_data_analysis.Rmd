...
grob1 = grobTree(textGrob(paste("Spearman Correlation : ", -0.209 ), x = 0.70, y = 0.90, hjust = 0, gp = gpar(col = "red", fontsize = 20)))

grob2 = grobTree(textGrob(paste("p-value : ", "0.0003" ), x = 0.70, y = 0.85, hjust = 0, gp = gpar(col = "red", fontsize = 20)))
...
grob1 = grobTree(textGrob(paste("Spearman Correlation : ", -0.279 ), x = 0.70, y = 0.90, hjust = 0, gp = gpar(col = "red", fontsize = 20)))

grob2 = grobTree(textGrob(paste("p-value : ", "< 0.0001" ), x = 0.70, y = 0.85, hjust = 0, gp = gpar(col = "red", fontsize = 20)))
